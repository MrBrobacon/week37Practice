...
*/
console.log("Task: E");
let peopleNames2 = [["Christian", "Simonsen"], ["Tony", "Bergholtz"]]

for (let i = peopleNames2.length - 1; i >= 0; i--) {
    console.log(peopleNames2 [i][0] + " " + peopleNames2[i][1]);
}
...
*/
console.log("Task: F");
let phoneNumbers = ["98672375", "40249314", "95823524"];
